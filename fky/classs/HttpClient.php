 ...
 * ```
 *
 * Example post request with post data:HttpClient
 *
 * ```php
 * $curl = new HttpClient();
...
class HttpClient
{
     ...
     */
    const USER_AGENT = 'BlockPHP httpClient/1.0';
     ...
     *
     * @param string $url
     *            The url to make the get request for
     * @param array $data
     *            Optional arguments who are part of the url
     * @return self
     */
     ...
     *            The url to make the get request
     * @param array $data
     *            Optional data to pass to the $url
     * @param bool $payload
     *            Whether the data should be transmitted trough payload or as get parameters of the string
     * @return self
     */
     ...
     *
     * @param string $url
     *            The url to make the delete request
     * @param array $data
     *            Optional data to pass to the $url
     * @param bool $payload
     *            Whether the data should be transmitted trough payload or as get parameters of the string
     ...
     *            The password for the given username for the authentification
     * @return self
     */
     ...
     *            The header key
     * @param string $value
     *            The value for the given header key
     * @return self
     */
     ...
     *            The name of the user agent to set for the current request
     * @return self
     */
     ...
     *            An url to pass and will be set as referer header
     * @return self
     */
     ...
     * @param string $value
     *            The value for the provided cookie name
     * @return self
     */
     ...
     *
     * @param int $option
     *            The curl option constante e.g. `CURLOPT_AUTOREFERER`, `CURLOPT_COOKIESESSION`
     * @param mixed $value
     *            The value to pass for the given $option
     */
    ...
    /**
     * Close the connection when the HttpClient object will be destroyed.
     */
